...
export const defaultProducts = [
  ...
  },
  {
    _id: "new-1-core",
    name: "2mm Core",
    description: "Premium 2mm core veneer for strong plywood structure and consistent performance.",
    image: productImageLinks["2mm Core"],
  },
  {
    _id: "new-1-fali",
    name: "2mm Fali",
    description: "Reliable 2mm fali veneer with clean grain and dependable adhesive performance.",
    image: productImageLinks["2mm Fali"],
  },
  {
    _id: "half-cut-8-inch",
    name: "Half Cut 8 Inch",
    description: "Premium Half Cut 8 Inch veneer for specialized plywood applications.",
