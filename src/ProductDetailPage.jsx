        ...
        <div className="max-w-7xl mx-auto px-5 md:px-10 grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link to="/products" className="px-8 py-3 text-sm font-bold uppercase tracking-wider text-white border-2 border-white rounded hover:bg-white hover:text-navy transition-all duration-300">All Products</Link>
            </div>
          </motion.div>
        </div>
      </section>
