...
const products = [
  ...
  { name: "2mm Core", tag: "Core Veneer", image: productImageLinks["2mm Core"] },
  { name: "2mm Fali", tag: "Fali Veneer", image: productImageLinks["2mm Fali"] },
  ...
  { name: "Half Cut 8 Inch", tag: "Specialty Veneer", image: productImageLinks["Half Cut 8 Inch"] },
];
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center pt-24 pb-32 overflow-hidden border-b-4 border-orange">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-5 md:px-10 text-center">
          <motion.p
            ...
            className="text-sm font-bold uppercase tracking-widest text-orange mb-4 [text-shadow:_0_2px_4px_rgb(0_0_0_/_0.5)]"
          >
            Premium Supply Partner
          </motion.p>
          <motion.h1
            variants={fadeUp} initial="hidden" animate="visible" custom={1}
            className="text-5xl md:text-6xl lg:text-8xl font-extrabold text-white leading-tight mb-6 [text-shadow:_0_8px_16px_rgb(0_0_0_/_0.5)] max-w-5xl mx-auto"
          >
          ...
          <motion.p
            ...
            className="text-lg md:text-2xl text-gray-100 mb-10 max-w-3xl mx-auto leading-relaxed [text-shadow:_0_4px_8px_rgb(0_0_0_/_0.5)] font-medium"
          >
      ...
      <section className="relative py-32 overflow-hidden border-t-4 border-orange">
        ...
        >
          <div className="inline-block mb-4 px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-sm border border-white/20">
            <span className="text-orange font-bold uppercase tracking-[0.2em] text-sm [text-shadow:_0_2px_4px_rgb(0_0_0_/_0.5)]">
              Start Your Supply Partnership
            </span>
          </div>

          <h2 className="text-5xl md:text-7xl font-extrabold text-white mb-8 leading-tight">
            <span className="[text-shadow:_0_10px_30px_rgb(0_0_0_/_0.5)]">Ready to scale your</span> <br className="hidden md:block" />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange to-yellow-400 drop-shadow-2xl">plywood production?</span>
          </h2>
